<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserImgComment.aspx.cs" Inherits="UserImgComment" %>
...
<body>
    ...
    <div>
		...
		<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
			ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
			InsertCommand="INSERT INTO [imagecomment] ([iname], [comment],[ename]) VALUES (@iname, @comment,@ename)" 
			SelectCommand="SELECT i.comment,i.ename,e.epath FROM imagecomment i inner join emppp e on i.ename=e.ename WHERE i.iname = @iiname">			
			<InsertParameters>

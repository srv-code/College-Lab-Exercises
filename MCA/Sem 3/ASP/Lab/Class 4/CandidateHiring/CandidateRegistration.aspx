                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Calendar ID="Calendar_DOB" runat="server" 
                                    ondayrender="Calendar_DOB_DayRender" 
                                    onselectionchanged="Calendar_DOB_SelectionChanged" Visible="False"></asp:Calendar>

                                <asp:TextBox ID="TextBox_DOB" runat="server" ReadOnly="True"></asp:TextBox>
                                <asp:Button ID="Button_SelectDob" runat="server" Text="Select" 
                                    CausesValidation="False" onclick="Button_SelectDob_Click" />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Label ID="Label_PasswordPolicyError" runat="server"
                                    Visible="false"
                                    Text="Must abide by password policy!"  
                                    CssClass="invalid">
                                </asp:Label>

...
<body>
    <form id="form1" runat="server">
			...
			<asp:Wizard ID="Wizard_Registration" runat="server"
				...
				<WizardSteps>
					...
					<asp:WizardStep ID="WizardStep_Submitted" runat="server" 
						...
						<asp:LinkButton ID="LinkButton_GotoRegistrationDataPage" runat="server" PostBackUrl="~/RegistrationData.aspx">View registration data</asp:LinkButton>
					</asp:WizardStep>
				</WizardSteps>
			</asp:Wizard>
		</div>
    	...
    	<asp:SqlDataSource ID="SqlDataSource_Student" runat="server" 
			...
			SelectCommand="SELECT * FROM [student]" ConflictDetection="CompareAllValues" 
			DeleteCommand="DELETE FROM [student] WHERE [id] = @original_id AND (([name] = @original_name) OR ([name] IS NULL AND @original_name IS NULL)) AND (([gender] = @original_gender) OR ([gender] IS NULL AND @original_gender IS NULL)) AND (([dob] = @original_dob) OR ([dob] IS NULL AND @original_dob IS NULL)) AND (([address] = @original_address) OR ([address] IS NULL AND @original_address IS NULL)) AND (([marks_10] = @original_marks_10) OR ([marks_10] IS NULL AND @original_marks_10 IS NULL)) AND (([marks_12] = @original_marks_12) OR ([marks_12] IS NULL AND @original_marks_12 IS NULL)) AND (([grade_ug] = @original_grade_ug) OR ([grade_ug] IS NULL AND @original_grade_ug IS NULL)) AND (([grade_pg] = @original_grade_pg) OR ([grade_pg] IS NULL AND @original_grade_pg IS NULL)) AND (([achievement] = @original_achievement) OR ([achievement] IS NULL AND @original_achievement IS NULL)) AND (([reference1] = @original_reference1) OR ([reference1] IS NULL AND @original_reference1 IS NULL)) AND (([reference2] = @original_reference2) OR ([reference2] IS NULL AND @original_reference2 IS NULL)) AND (([reference3] = @original_reference3) OR ([reference3] IS NULL AND @original_reference3 IS NULL))" 
			InsertCommand="INSERT INTO [student] ([name], [gender], [dob], [address], [marks_10], [marks_12], [grade_ug], [grade_pg], [achievement], [reference1], [reference2], [reference3]) VALUES (@name, @gender, @dob, @address, @marks_10, @marks_12, @grade_ug, @grade_pg, @achievement, @reference1, @reference2, @reference3)" 
			OldValuesParameterFormatString="original_{0}" 
			UpdateCommand="UPDATE [student] SET [name] = @name, [gender] = @gender, [dob] = @dob, [address] = @address, [marks_10] = @marks_10, [marks_12] = @marks_12, [grade_ug] = @grade_ug, [grade_pg] = @grade_pg, [achievement] = @achievement, [reference1] = @reference1, [reference2] = @reference2, [reference3] = @reference3 WHERE [id] = @original_id AND (([name] = @original_name) OR ([name] IS NULL AND @original_name IS NULL)) AND (([gender] = @original_gender) OR ([gender] IS NULL AND @original_gender IS NULL)) AND (([dob] = @original_dob) OR ([dob] IS NULL AND @original_dob IS NULL)) AND (([address] = @original_address) OR ([address] IS NULL AND @original_address IS NULL)) AND (([marks_10] = @original_marks_10) OR ([marks_10] IS NULL AND @original_marks_10 IS NULL)) AND (([marks_12] = @original_marks_12) OR ([marks_12] IS NULL AND @original_marks_12 IS NULL)) AND (([grade_ug] = @original_grade_ug) OR ([grade_ug] IS NULL AND @original_grade_ug IS NULL)) AND (([grade_pg] = @original_grade_pg) OR ([grade_pg] IS NULL AND @original_grade_pg IS NULL)) AND (([achievement] = @original_achievement) OR ([achievement] IS NULL AND @original_achievement IS NULL)) AND (([reference1] = @original_reference1) OR ([reference1] IS NULL AND @original_reference1 IS NULL)) AND (([reference2] = @original_reference2) OR ([reference2] IS NULL AND @original_reference2 IS NULL)) AND (([reference3] = @original_reference3) OR ([reference3] IS NULL AND @original_reference3 IS NULL))">
			<DeleteParameters>

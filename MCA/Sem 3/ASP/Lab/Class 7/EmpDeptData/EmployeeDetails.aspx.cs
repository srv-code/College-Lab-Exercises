...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e) {
		...
		string newLocation = ((DropDownList)GridView_EmpLoc.FooterRow.FindControl("DropDownList_NewDepartment")).SelectedValue;
        ...
        SqlDataSource_Employees.InsertParameters["department"].DefaultValue = newLocation;
